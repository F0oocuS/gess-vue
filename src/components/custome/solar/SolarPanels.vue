<template>
    <section class="panels">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-4 col-xl-2" v-for="item in solarPanels.list">
                    <div class="panels__item">
                        <img src="http://via.placeholder.com/250x270" alt="">
                        ...
                        <div class="panels__desc">
                            ...
                            <button class="more-info" data-toggle="modal" data-target="solar-modal">More</button>
                        </div>
                    </div>
                </div>
            </div>
